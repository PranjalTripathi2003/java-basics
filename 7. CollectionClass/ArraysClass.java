// Arrays class extends the functionality of PRIMITIVE ARRAYS ( not arrayslist)
...
public class ArraysClass {
    public static void main(String[] args) {
        ...
        /*
        int index = Arrays.binarySearch(numbers,4); // Does a binary search on the array, and returns its index
