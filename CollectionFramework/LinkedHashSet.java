// All the functionality is same as HashSet, except the elements will be stored as a Linked List type, and the elements will be printed one after the other, like in LinkedList.
