...
public class LearnArrayDeque {
    // Deque - Stands for doubly ended queue. That means we can remove/add from the front or the rear both. This is used in Sliding Window.
...
// To check what elements will be removed from the first and the last of the ArrayDeque
