...
public class MyHashSet {
    public static void main(String[] args) {
        ...
        // Instead of writing "Set<Integer>" we can also write "HashSet<Integer>" since
        // HashSet belongs to Set only, but that will be more work, we have seen this
        // type of syntax in priority queue also.
