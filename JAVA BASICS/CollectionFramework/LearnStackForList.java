...
public class LearnStackForList {
    public static void main(String[] args) {
        Stack<String> animals = new Stack<>();
        // Stack by default uses the one and only way it is implemented that is using the "List" interface.
        ...
        // To remove an element from the stack, which would be top of the stack ofc, we use the pop() functon
